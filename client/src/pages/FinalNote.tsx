...
export default function FinalNote() {
  ...
  const fullText = "You’re not just part of my life — you’ve become the quiet certainty behind every breath, every pause, and every tomorrow. What I feel for you isn’t something I switch on or off; it’s simply the way my heart has learned to exist. You’ve settled into the deepest parts of me, not as a feeling, but as the person I find in every thought, every silence, every piece of my future. You’re the part of me that feels right in every moment and every tomorrow waiting ahead.";
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-gray-500 italic">
            Everything I Made Here Is From The Bottom Of My Heart, Just For You. I Hope It Brings A Smile To Your Face And Warms Your Heart As Much As You Do To Mine.
          </p>
        </motion.div>
      </div>
    </div>
