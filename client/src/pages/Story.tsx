  ...
  const sortedStory = [
    {
      ...
      content: "From the moment our eyes met, I knew there was something extraordinary about you.  It was as if time slowed for a heartbeat, and in that gentle pause, something meaningful shifted inside me.",
